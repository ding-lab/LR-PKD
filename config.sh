...
input_build=" " # Reference built GRCh38 or GRCh37
input_target_bed=" " # Target BED files required by WES longranger targeted. Users can choose to use their own BED or use the one provided in LR-PKD source
input_CNV_bed=" " # CNV BED files required by WES longranger targeted. Users can choose to use their own BED or use the one provided in LR-PKD source
