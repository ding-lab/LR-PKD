...
${samtools_path} view -b ${path_variant}/phased_possorted_bam.bam -L PKD1P_all.bed -o PKD1_all_10x${input_datatype}.bam
${samtools_path} index PKD1P_all_10x$input_datatype.bam
${samtools_path} view -b ${path_variant}/phased_possorted_bam.bam -L PKD1P_coding.bed -o PKD1_coding_10x${input_datatype}.bam
